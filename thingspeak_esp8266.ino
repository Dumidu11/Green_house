...
String apiKey = "S6FPB5URU3N69KME";     // replace with your channel's thingspeak WRITE API key

String ssid="HUAWEI-4B34";    // Wifi network SSID
String password ="01285353";  // Wifi network password
